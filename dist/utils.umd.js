(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('util'), require('events'), require('lodash')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'util', 'events', 'lodash'], factory) :
  (global = global || self, factory(global.utils = {}, global.React, global.util, global.events, global.lodash));
}(this, function (exports, React, util, events, lodash) { 'use strict';
  ...
  config.html = utilities.invertObject(HTMLDOMPropertyConfig_1.DOMAttributeNames);
  ...
  config.svg = utilities.invertObject(SVGDOMPropertyConfig_1.DOMAttributeNames);
  ...
  var config$1 = propertyConfig.config;
  ...
  function attributesToProps(attributes) {
    ...
    for (propertyName in attributes) {
      ...
      reactProperty = config$1.html[propertyName.toLowerCase()];
      if (reactProperty) {
        if (
      ...
      reactProperty = config$1.svg[propertyName];
      if (reactProperty) {
        props[reactProperty] = propertyValue;
  ...
  */
  ...
  function formatDate(value) {
    ...
    return value ? dateFns_50(value, dateFormat) : EMPTY_FIELD;
  }
  ...
  function parseAndPreserveNewlines(body) {
    ...
    return htmlReactParser(preserveNewLines(escapedBody));
  }
  ...
  function varToLabel(str) {
    ...
    return formatted.replace(/[A-Za-z0-9\u00C0-\u00FF]+[^\s-]*/g, function (match, index$$1, title) {
      if (index$$1 > 0 && index$$1 + match.length !== title.length && match.search(smallWords) > -1 && title.charAt(index$$1 - 2) !== ':' && (title.charAt(index$$1 + match.length) !== '-' || title.charAt(index$$1 - 1) === '-') && title.charAt(index$$1 - 1).search(/[^\s-]/) < 0) {
