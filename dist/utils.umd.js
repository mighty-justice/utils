(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('mobx'), require('mobx-react'), require('classnames'), require('iso8601-duration'), require('date-fns'), require('numeral'), require('html-react-parser'), require('lodash')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'mobx', 'mobx-react', 'classnames', 'iso8601-duration', 'date-fns', 'numeral', 'html-react-parser', 'lodash'], factory) :
  (global = global || self, factory(global.utils = {}, global.React, global.mobx, global.mobxReact, global.cx, global.iso8601Duration, global.dateFns, global.numeral, global.parser, global.lodash));
}(this, function (exports, React, mobx, mobxReact, cx, iso8601Duration, dateFns, numeral, parser, lodash) { 'use strict';
