...
import { isString, isNumber, has, result, get, times as times$2, isBoolean, escape, startCase, sortBy, map as map$1, reject, mapValues } from 'lodash';
...
function formatPercentage(value) {
  ...
  var zeros = times$2(decimalPoints, function () {
    return '0';
  }).join(''),
...
function parseAndPreserveNewlines(body) {
  ...
  return htmlReactParser(preserveNewLines(escape(body)));
}
